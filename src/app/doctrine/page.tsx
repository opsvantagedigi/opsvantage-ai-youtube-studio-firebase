  ...
  return (
    <div className="prose prose-slate max-w-3xl py-10">
      ...
      <p>
        ...
        explains the principles, rituals, and architectural decisions that
        guide how this system is built and maintained. Every part of this
        platform is designed with clarity, safety, and legacy in mind.
      </p>
      ...
      <p>
        Use <code>auditEvent()</code> from <code>src/lib/auth/audit.ts</code> to log events. Include metadata and tenant context.
      </p>
