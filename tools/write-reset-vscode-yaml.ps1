# Self-writing version: This script writes the clean reset-vscode-yaml.ps1 to disk
$out = @'
...
Set-Content -Path "tools/reset-vscode-yaml.ps1" -Value $out -Encoding utf8 -NoNewline
Write-Host "Self-writing script complete."
