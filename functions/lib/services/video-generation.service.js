...
class VideoGenerationService {
     ...
     */
    async generateVideoFromScript(scriptId, style = 'cinematic') {
     ...
     */
    async generateVideoFromScenes(sceneBreakdown, style = 'cinematic') {
        switch (this.config.provider) {
            case 'pika':
    ...
    async generateWithPika(script, style) {
    ...
    async generateWithPikaFromScenes(scenes, style) {
    ...
    async generateWithRunway(script, style) {
    ...
    async generateWithRunwayFromScenes(scenes, style) {
    ...
    async generateWithDId(script, style) {
    ...
    async generateWithDIdFromScenes(scenes, style) {
    ...
    async generateWithHeygen(script, style) {
    ...
    async generateWithHeygenFromScenes(scenes, style) {
